 ...
 */
	...
	if ($_GET['forms'] === ADD_FRM)	// selected to add either a table or a form
	{
...
//			'title' => t('_move this table in another database'),
			'label' => t('_Form name'),//t('_Database name'),
			'label_title' => t('_alpha-numeric characters'),//t('_Database name'),
			'value' => (isset($_POST['fname']) && !empty($_POST['fname'])) ? $_POST['fname'] : '',
...
//			'show_optional' => false,
		...
		$submit = array(
			...
			'input_class' => 'submit',
			'value' => t('_Add form'),//t('_Add database'),//('_Submit')
			'type' => 'submit',
...
<?php	echo Breadcrumbs::here(); ?>
				<h1>
					...
					<span class="xthis-page"><?=t('_Add a new form')?></span>
