...
final class Hook implements \Iterator, \ArrayAccess {
	...
	{
		return print_r($this->callbacks, true);
	}
	...
	public function add( $hook_name, $callback, $priority, $accepted_args )
	{
		$idx = $this->_unique_id( $hook_name, $callback, $priority );
	...
	public function remove( $hook_name, $callback, $priority )
	{
		$function_key = $this->_unique_id( $hook_name, $callback, $priority );
	...
	public function has( $hook_name = '', $callback = false )
	{
		...
		$function_key = $this->_unique_id( $hook_name, $callback, false );
...
/*		foreach ( $this->callbacks as $callbacks ) {
	...
	//public function apply( $value, $args=null )
	...
	/**
	 * Normalizes filters set up to Hook objects.
	 *
	 ...
	 */
	private function _unique_id( $hook_name, $callback, $priority )
	{
