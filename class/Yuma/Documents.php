...
class Documents extends CRUD
{
	...
	const error = "error";
	const TABLE = 'yumatech_organise.document';
	...
	//protected static $tbl = 'yumatech_organise.document';
	//protected static $id = 'document_id';
	//protected static $name = 'name';
	protected static $use;

	private static function findName($var)
	{
		return $var[self::NAME] == self::$use;
	}
