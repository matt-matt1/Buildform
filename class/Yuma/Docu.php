...
class Docu
{
	public function render()
	{
		ob_start();
?>
	<!--form id="admin_form" method="POST" action="<?=BASE. 'admin'?>"<?=defined('CHARSET') ? ' accept-charset="UTF-8"' : ''?> autocomplete="off"-->
	<form id="document_form" method="POST" action="<?=BASE. 'admin'?>"<?=defined('CHARSET') ? ' accept-charset="UTF-8"' : ''?> autocomplete="off">
		<fieldset id="document" class="main-fieldset">
...
//						'noLabel' => true,
	...
	echo Field::out(array(
						...
						'showOptional' => false,
						//'canWipe' => true,
						'placeholder' => 'Document name - search as you type',
//						'inputWrapClass' => 'has-feedback',
						'default_' => 'Search for a Document name - start typing - select a suggestion',
...
//						'description' => 'Last updated',
	...
	echo Field::out(array(
						...
						'id' => 'document_note',
						//'rowClass' => "row mb-2 g-2",
						'placeholder' => 'This is a good document.',
						'noLabel' => true,//'label' => false,
//						'description' => 'Notes',
						'default_' => 'Notes',
						'type' => 'textarea',
