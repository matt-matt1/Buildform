<fieldset id="business" class="main-fieldset">
	<legend>Business</legend>
	<button type="submit" style="position:absolute" name="action" value="add-business" class="btn btn-primary addButton" id="add-business"><i class="fa-solid fa-circle-plus fa-2xl" style="padding-left: 0.5em;"></i>Add new business</button>
<?php
...
//					),
	...
	//							'style' => 'height:2.5em',
							...
							'fieldset0' => array(
								...
								'inner' => array(*/
?></fieldset>
<fieldset id="contacts" class="xmain-fieldset">
	<legend>Contacts</legend>
	<button type="submit" style="position:absolute" name="action" value="add-contact" class="btn btn-secondary addButton" id="add-contact"><i class="fa-solid fa-circle-plus fa-2xl" style="padding-left: 0.5em;"></i>Add new contact</button>
	<fieldset id="div-contact_0" class="contact">
<?php
	echo Field::out(array(
										'id' => 'contact_id_0',
