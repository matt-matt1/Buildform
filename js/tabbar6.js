    ...
    if (n || (n = "undefined" != typeof Symbol && Symbol.iterator in Object(t) ? Array.from(t) : void 0), !n)
        t:
        {
            if (t) {
                ...
                if ("Object" === (n = Object.prototype.toString.call(t).slice(8, -1)) && t.constructor && (n = t.constructor.name), "Map" === n || "Set" === n) {
                    n = Array.from(n);
                    break t
                }
...
!function() {
    ...
    function i(t) {
        return 1 / 0 === t.iterationCount ? 1 / 0 : Math.max((t.startDelay || 0) + (t.duration || 0) * (t.iterationCount || 1) + (t.endDelay || 0), 0)
    }
    function l(t, e, r, o, i) {
        return i ? i(e, r, o, "0%" === t ? "start" : "end") : ("block" === r ? r = "vertical" : "inline" === r && (r = "horizontal"), e = "vertical" === r ? e.scrollHeight - e.clientHeight : e.scrollWidth - e.clientWidth, "%" === (t = n("auto" === o ? t : o)).unit ? parseFloat(t.value) * e / 100 : parseFloat(t.value))
    }
    var a = new WeakMap,
        c = [],
        s = function() {
            function t(t) {
                a.set(this, {
                    ...
                    animations: [],
                    animationOptions: []
                }), this.scrollSource = t && t.scrollSource || document.scrollingElement, this.orientation = t && t.orientation || "block", this.startScrollOffset = t && t.startScrollOffset || "auto", this.endScrollOffset = t && t.endScrollOffset || "auto", this.timeRange = t && t.timeRange || "auto", this.fill = t && t.fill || "none"
            }
            return e(t, [{
                key: "scrollSource",
                set: function(t) {
                    var e = this;
                    this.scrollSource && r(this.scrollSource).removeEventListener("scroll", (function() {
                        return o(e)
                    })), t instanceof Element || (t = document.scrollingElement), a.get(this).scrollSource = t, r(t).addEventListener("scroll", (function() {
                        return o(e)
                    })), o(this)
                },
                get: function() {
                ...
                key: "orientation",
                set: function(t) {
                    -1 === ["block", "inline", "horizontal", "vertical"].indexOf(t) && (t = "block"), a.get(this).orientation = t, o(this)
                },
                get: function() {
                ...
                set: function(t) {
                    ...
                    for (var e = 0; e < c.length; e++) {
                        var n = c[e].parse(t);
                        if (void 0 !== n) {
                            t = n, a.get(this).endScrollOffsetFunction = c[e].evaluate;
                            break
                        }
                    }
                ...
                get: function() {
                    ...
                    var t,
                        e,
                        n = l("0%", this.scrollSource, this.orientation, this.startScrollOffset, a.get(this).startScrollOffsetFunction),
                        r = l("100%", this.scrollSource, this.orientation, this.endScrollOffset, a.get(this).endScrollOffsetFunction),
                        o = this.timeRange;
                    if ("auto" === o) {
                        o = 0;
                        for (var c = a.get(this).animationOptions, s = 0; s < c.length; s++)
                            o = Math.max(o, i(c[s]));
                        1 / 0 === o && (o = 0)
                    }
                    return c = this.scrollSource.scrollTop, "inline" !== this.orientation && "horizontal" !== this.orientation || (c = this.scrollSource.scrollLeft), c < n ? "none" === this.fill || "forwards" === this.fill ? null : 0 : c >= r ? r < (t = this.scrollSource, "block" === (e = this.orientation) ? e = "vertical" : "inline" === e && (e = "horizontal"), "vertical" === e ? t.scrollHeight - t.clientHeight : "horizontal" === e ? t.scrollWidth - t.clientWidth : void 0) && ("none" === this.fill || "backwards" === this.fill) ? null : o : (c - n) / (r - n) * o
                }
            }, {
                key: "__polyfill",
                get: function() {
        ...
        u = new WeakMap,
        f = [[[0, 1, 2, 3]], [[0, 2], [1, 3]], [[0], [1, 3], [2]], [[0], [1], [2], [3]]],
        h = function() {
            function t(t) {
                u.set(this, {
                    target: null,
            ...
            return e(t, [{
                ...
                set: function(t) {
                    if (!(t instanceof Element))
                        throw u.get(this).target = null, Error("Intersection target must be an element.");
                    u.get(this).target = t
                },
                get: function() {
                ...
                get: function() {
                    return u.get(this).rootMargin.map((function(t) {
                        return t.join("")
                    })).join(" ")
                }
            }, {
    ...
    if (c.push({
        ...
        evaluate: function(t, e, n) {
            ...
            for (var r, o = t == document.scrollingElement ? {
                    left: 0,
                    right: t.clientWidth,
                    top: 0,
                ...
                } : t.getBoundingClientRect(), i = u.get(n).rootMargin, l = [], a = 0; 4 > a; a++)
                l.push("%" == (r = i[a])[1] ? r[0] * (0 == a % 2 ? o.height : o.width) / 100 : r[0]);
            i = o.left - l[3], r = o.right - o.left + l[3] + l[1], a = o.top - l[0], l = o.bottom - o.top + l[0] + l[2], o = u.get(n).clamp;
            var c = n.target.getBoundingClientRect(),
                s = n.threshold;
            return "start" == n.edge && (s = 1 - s), "vertical" == e ? (e = c.top + c.height * s - a + t.scrollTop, o ? "end" == n.edge ? Math.max(0, e - l) : Math.min(e, t.scrollHeight - l) : "end" == n.edge ? e - l : e) : (e = c.left + c.width * s - i + t.scrollLeft, o ? "end" == n.edge ? Math.max(0, e - r) : Math.min(e, t.scrollWidth - r) : "end" == n.edge ? e - r : e)
        }
